...
import { selectSocket } from '../redux/store'
...
import SignalComponent from '../lib/signal/test'
      ...
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body gap-4">
          ...
          <div className="card-actions">
            ...
            <button onClick={ () => {
              router.replace("/chat")
            }} className="btn btn-primary btn-block gap-2">{socket.id} <ArrowRightIcon className='w-5 h-5'></ArrowRightIcon></button>
          </div>
        </div>
      </div>
    </main>
